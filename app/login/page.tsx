...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main className="px-3 mx-auto" style={{ maxWidth: 420, marginTop: "10vh" }}>
      <div className="text-center mb-4"><i className="bi bi-mortarboard-fill text-primary" style={{ fontSize: "2.6rem" }} /><h1 className="h3 fw-bold mt-2 mb-1">Teacher Assistant</h1><p className="text-body-secondary">登入教學助理系統</p></div>
