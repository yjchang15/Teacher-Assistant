  ...
  return (
    <main className="desktop-dashboard">
      ...
      <section className="workspace-panel">
        ...
        {selectedAssignment ? <>
          <DoubleClickSeatGrid key={assignmentId} assignmentId={assignmentId} seatCount={selectedClass?.seat_count ?? 32} students={students.map(({seat,name})=>({seat,name}))} missingSeats={missingSeats} action={toggleAssignmentSeat} />
        </> : (
